...
const StrategicPlanningSponsors = ({ slice }: Props) => {
  ...
  return (
    <section className="bg-[#fff] border-none md:border-t border-[#DEDEDE] mt-[48px]">
      <div className="mx-auto max-w-full md:max-w-[720px] xl:max-w-[1280px] py-[60px] md:py-[0px] flex flex-col md:flex-row justify-between items-start md:items-center gap-[16px] md:gap-8 px-[0px]">
...
export default StrategicPlanningSponsors; 