...
succesfully
      ...
      <p className="w-full text-[16px] text-[#475467] text-center font-[400] font-inter">{`Your password has been successfully updated.`}</p>
      <Form.Item className="!mb-0 !mt-[32px]">
        <BaseButton
          ...
          onClick={onFinish}
        >
          <span className="font-oswald !text-[#fff]">BACK TO DASHBOARD</span>
        </BaseButton>
      </Form.Item>
