...
const CallToAction = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage:
          'linear-gradient(rgba(0, 0, 0, 0.45), rgba(0, 0, 0, 0.45)), url(/images/cta-background.jpg)',
      }}
    >
      <div className="container mx-auto flex flex-col items-center text-center gap-[24px] xl:gap-6">
        ...
        <div className="flex flex-row gap-4 pt-4">
          ...
          <BaseButton onClick={() => {
            window.open('https://www.nass.us/aboutnass', '_blank');
          }} className="bg-transparent h-auto" size="large">
            <span className="text-[#212B36] text-[16px] font-[500] font-oswald">LEARN MORE</span>
          </BaseButton>
        </div>
      </div>
    </section>
