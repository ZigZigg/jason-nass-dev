...
export default function ForgotPasswordMain() {
  ...
  return (
    <div
      className={`md:mt-[0px] w-full h-auto md:h-[100vh] landscape:max-lg:h-[auto] flex flex-col align-center justify-center items-center px-[20px] landscape:max-lg:py-[24px] md:px-[0px] bg-[#F4F9FF] pb-[40px] md:pb-[0px]`}
    >
